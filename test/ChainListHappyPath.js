...
contract('ChainList', function(accounts){
  ...
  it("should let us sell a first article", function() {
    return ChainList.deployed().then(function(instance) {
      ...
      assert.equal(data[5], web3.toWei(articlePrice1, "ether"), "article pricce must be "+web3.toWei(articlePrice1, "ether"));
    });
  });
  ...
  it("should let us sell a second article", function() {
    return ChainList.deployed().then(function(instance) {
      ...
      assert.equal(data[5], web3.toWei(articlePrice2, "ether"), "article pricce must be "+web3.toWei(articlePrice2, "ether"));
    });
  });
  ...
  it("should buy an article", function(){
    return ChainList.deployed().then(function(instance) {
      ...
      assert.equal(data[0].toNumber(), 2, "article 2 should be only article left for sale");
